...
const Cart = () => {
  ...
  return (
    <div className='border-t pt-14 min-h-[55vh]'>
      ...
      <div className='flex justify-end my-20'>
        <div className='w-full sm:w-[450px]'>
          ...
          <div className='w-full text-end'>
            <button onClick={() => navigate('/place-order')} className='bg-slate-400 text-white text-sm my-8 px-8 py-3 hover:bg-black transition-all duration-500'>PROCEED TO CHECKOUT</button>
          </div>
        </div>
      </div>
    </div>
